...
| Item | Repo | Status |
|------|------|--------|
| Core compiler (ingest → weave) | stubborn | ✅ Beta `0.10.0b2` on PyPI |
...
| MCP server package | stubborn-mcp | ✅ `0.10.0b2` on PyPI |
...
| Doctor aggregation CLI ([ADR-016](https://github.com/stubborn-ai/stubborn/blob/main/docs/adr/ADR-016-doctor-status-aggregation.md)) | stubborn-status | ✅ `0.10.0b2` |

## Phase 2 — Dev loop

| Item | Repo | Status |
|------|------|--------|
| `stubborn-watch` (Java, debounced) | stubborn-watch | ✅ `0.10.0b2` on PyPI |
